...
const Register = ({ onSuccess }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-transparent">
      ...
      <form
        onSubmit={handleSubmit}
        className="w-full max-w-[420px] bg-[#fdf7ef] text-[#3b2a1a]
        rounded-xl shadow-2xl border border-[#d6b97b]
        p-6 sm:p-8 md:p-10"
      >
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-[#7a2e1f]">
        ...
        <input
          ...
          ref={FullNameR}
          required
          className="w-full mb-4 px-4 py-2 rounded bg-white border border-[#d6b97b]"
        />
        ...
        <div className="relative mb-6">
          <input
            ...
            ref={PasswordR}
            required
            className="w-full px-4 py-2 pr-11 rounded bg-white border border-[#d6b97b]"
          />
          <button
            type="button"
            onClick={() => setShowPassword(!showPassword)}
        ...
        <p className="text-center text-sm mt-2 text-[#5a1f14]">
          Already have an account? <NavLink to="/login" className="text-[#c9a24d] hover:underline">Login here</NavLink>
        </p>
      </form>
    </div>
  );
